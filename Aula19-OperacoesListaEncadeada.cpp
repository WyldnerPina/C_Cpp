...
//============================================ FUNÇÕES ===============================================
void limpatela(); /*************************************************************************** 01 ***/
int retornaTamanhoListaEncadeada(pessoa *ponteiroEncadeada); /******************************** 02 ***/
void imprimeEncadeada(pessoa *ponteiroEncadeada); /******************************************* 03 ***/
void adcComecoEncadeada(pessoa *&ponteiroEncadeada, string nome, int rg); /******************* 04 ***/
void adcFimEncadeada(pessoa *ponteiroEncadeada, string nome, int rg); /*********************** 05 ***/
void adcPosicaoEncadeada(pessoa *ponteiroEncadeada,string nome,int rg, int posicao); /******** 06 ***/
void removeInicioEncadeada(pessoa *&ponteiroEncadeada, string *nome, int *rg); /************** 07 ***/
void removeFinalEncadeada(pessoa *&ponteiroEncadeada, string *nome, int *rg); /*************** 08 ***/
void removePosicaoEncadeada(pessoa *ponteiroEncadeada,string *nome,int *rg, int posicao); /*** 09 ***/

void minhaFuncaoIserirNomes(); /************************************************************** 10 ***/
